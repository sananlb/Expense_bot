...
"Покажи траты за июль"''',
        ...
        # --- Лимиты трат ---
        'limit_button_set': '🚦 Установить лимит',
        'limit_button_with_amount': '🚦 Лимит: {amount}/мес',
        'limit_category_header': '🚦 Лимит для категории\n{category}',
        'limit_screen_body': (
        ...
        # --- Общий лимит трат ---
        'total_limit_button': '🚦 Лимит трат',
        'total_limit_header': '🚦 Общий лимит трат',
...
"Show expenses for July"''',
        ...
        # --- Spending limits ---
        'limit_button_set': '🚦 Set limit',
        'limit_button_with_amount': '🚦 Limit: {amount}/mo',
        'limit_category_header': '🚦 Category limit\n{category}',
        'limit_screen_body': (
        ...
        'total_limit_button': '🚦 Spending limit',
        'total_limit_header': '🚦 Total spending limit',
        'total_limit_explainer': (

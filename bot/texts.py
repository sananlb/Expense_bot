...
"Покажи траты за июль"''',
        ...
        'categories_subscription_note': '⚠️ <i>Редактирование категорий доступно только с подпиской</i>',
        'add_button': '➕ Добавить',
...
Пример: "альфабанк 5% 2000 руб"''',
        ...
        'menu': 'Меню',
        'help': '❓ Справка',
        'diary_button': '📋 Дневник трат',
        'diary_title': '📋 <b>Дневник трат</b>',
        ...
        'recurring_button': '🔄 Ежемесячные платежи',
...
Спасибо за участие в тестировании! Ваши отзывы помогают улучшать бот.''',
        ...
        'want_to_add_expense': '💰 Вы хотите внести трату "{text}"?\n\nУкажите сумму траты:',
        ...
        'earned_days': '🎁 Получено дней',
        'referral_list': '📃 <b>Ваши рефералы:</b>',
        'no_referrals_yet': 'У вас пока нет рефералов',
        'invite_friends_bonus': 'Приглашайте друзей и получайте бонусы!',
...
"Show expenses for July"''',
        ...
        'categories_subscription_note': '⚠️ <i>Category editing is available only with subscription</i>',
        'add_button': '➕ Add',
        'edit_button': '✏️ Edit',
...
Example: "alphabank 5% 2000 rub"''',
        ...
        'menu': 'Menu',
        'help': '❓ Help',
        'diary_button': '📋 Expense diary',
        'diary_title': '📋 <b>Expense diary</b>',
        ...
        'recurring_button': '🔄 Recurring payments',
...
Thank you for participating in testing! Your feedback helps improve the bot.''',
        ...
        'want_to_add_expense': '💰 Do you want to add expense "{text}"?\n\nEnter expense amount:',
        ...
        'earned_days': '🎁 Days earned',
        'referral_list': '📃 <b>Your referrals:</b>',
        'no_referrals_yet': 'You have no referrals yet',
        'invite_friends_bonus': 'Invite friends and get bonuses!',
        ...
        'copy_link': '📋 Copy Link',
        'my_statistics': '📊 My Statistics',
        'referral_program_text': '🎁 <b>Referral Program</b>\n\nInvite friends and get bonuses!\n\nFor each friend who subscribes, you get <b>30 days</b> of free subscription.\n\nClick the button below to get your personal link.',
        'referral_your_program': '🎁 <b>Your Referral Program</b>\n\nYour link:\n<code>{link}</code>\n\n📊 Statistics:\nFriends invited: {total_referrals}\nActive subscriptions: {active_referrals}\nBonuses received: {total_bonuses} × 30 days\n\nFor each friend with a paid subscription you get 30 days free!',

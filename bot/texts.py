...
Получайте красивые отчеты с графиками''',
        ...
        # Ежемесячные платежи
        'recurring_payments': '🔄 Ежемесячные платежи',
        'recurring_menu': '🔄 Ежемесячные платежи',
        'no_recurring_payments': 'У вас пока нет регулярных платежей.',
        'add_recurring': '➕ Добавить',
        'edit_recurring': '✏️ Редактировать',
        'delete_recurring': '➖ Удалить',
        'add_recurring_payment': '➕ Добавление регулярного платежа',

...
"Покажи траты за июль"''',
        ...
        # --- Лимиты трат ---
        'limit_button_set': '🎚️ Установить лимит',
        'limit_button_with_amount': '🎚️ Лимит: {amount}/мес',
        'limit_category_header': '🎚️ Лимит для категории\n{category}',
        'limit_screen_body': (
            'Лимит: <b>{amount}</b> в месяц\n'
            'Потрачено: {spent} ({percent}%)\n'
            'До конца месяца: {days_left}'
        ),
        'limit_edit_button': '✏️ Изменить лимит',
        'limit_remove_button': '🗑 Убрать лимит',
        'limit_input_prompt': (
            '🎚️ Установка лимита\n{category}\n\n'
            'Введите сумму лимита на месяц, например: 10000'
        ),
        'limit_input_prompt_change': (
            '🎚️ Изменение лимита\n{category}\n\n'
            'Текущий лимит: {amount}. Введите новую сумму на месяц, например: 10000'
        ),
        'limit_set_success': '✅ Лимит установлен: {amount}/мес',
        'limit_removed_success': '✅ Лимит убран',
        'limit_invalid_amount': '❌ Введите корректную сумму лимита больше нуля',
        'limit_days_left_one': '{n} день',
        'limit_days_left_few': '{n} дня',
        'limit_days_left_many': '{n} дней',
        # --- Общий лимит трат ---
        'total_limit_button': '🎚️ Лимит трат',
        'total_limit_header': '🎚️ Общий лимит трат',
        'total_limit_explainer': (
            '💡 <i>Прогресс отображается в меню «Бюджет» — шкала под суммой '
            'расходов за месяц. При достижении 80% и 100% лимита придёт '
            'уведомление. Лимиты на отдельные категории можно установить в меню '
            '«Категории» → ✏️ Редактировать → выбор категории.</i>'
        ),
        'total_limit_input_prompt': (
            '🎚️ Общий лимит трат\n\n'
            '💡 <i>Прогресс будет отображаться в меню «Бюджет» — шкала под суммой '
            'расходов за месяц. При достижении 80% и 100% лимита придёт '
            'уведомление. Лимиты на отдельные категории можно установить в меню '
            '«Категории».</i>\n\n'
            'Введите сумму лимита на месяц, например: 50000'
        ),
        'total_limit_input_prompt_change': (
            '🎚️ Общий лимит трат\n\n'
            'Текущий лимит: {amount}. Введите новую сумму на месяц, например: 50000'
        ),
        # --- Уведомления о порогах ---
        'limit_alert_category_exceeded': (
            '🔴 <b>Превышен лимит!</b>\n\n'
            '{category}\n'
            'Лимит: {amount}\n'
            'Потрачено: {spent} ({percent}%)\n'
        ...
        'limit_alert_total_80': (
            '🟡 <b>Достигнуто 80% лимита трат</b>\n\n'
            'Потрачено: {spent} / {amount}\n'
            'Осталось: {remaining}\n'
            'До конца месяца: {days_left}'
        ),
        'limit_alert_total_exceeded': (
            '🔴 <b>Превышен общий лимит трат!</b>\n\n'
            'Лимит: {amount}\n'
            'Потрачено: {spent} ({percent}%)\n'
            'До конца месяца: {days_left}'
        ),
        # --- Цели по доходам ---
        'goal_button_set': '🎯 Установить цель',
        'goal_button_with_amount': '🎯 Цель: {amount}/мес',
        'goal_category_header': '🎯 Цель для категории\n{category}',
        'goal_screen_body': (
            'Цель: <b>{amount}</b> в месяц\n'
            'Получено: {received} ({percent}%)\n'
            'До конца месяца: {days_left}'
        ),
        'goal_edit_button': '✏️ Изменить цель',
        'goal_remove_button': '🗑 Убрать цель',
        'goal_input_prompt': (
            '🎯 Установка цели\n{category}\n\n'
            'Введите сумму цели на месяц, например: 100000'
        ),
        'goal_input_prompt_change': (
            '🎯 Изменение цели\n{category}\n\n'
            'Текущая цель: {amount}. Введите новую сумму на месяц, например: 100000'
        ),
        'goal_removed_success': '✅ Цель убрана',
        'goal_invalid_amount': '❌ Введите корректную сумму цели больше нуля',
        'total_goal_button': '🎯 Цель дохода',
        'total_goal_header': '🎯 Общая цель дохода',
        'total_goal_explainer': (
            '💡 <i>Прогресс отображается в меню «Бюджет» — шкала под суммой '
            'доходов за месяц. При достижении 100% цели придёт уведомление. '
            'Цели на отдельные категории можно установить в меню '
            '«Категории доходов» → ✏️ Редактировать → выбор категории.</i>'
        ),
        'total_goal_input_prompt': (
            '🎯 Общая цель дохода\n\n'
            '💡 <i>Прогресс будет отображаться в меню «Бюджет» — шкала под суммой '
            'доходов за месяц. При достижении 100% цели придёт уведомление. '
            'Цели на отдельные категории можно установить в меню '
            '«Категории доходов».</i>\n\n'
            'Введите сумму цели на месяц, например: 150000'
        ),
        'total_goal_input_prompt_change': (
            '🎯 Общая цель дохода\n\n'
            'Текущая цель: {amount}. Введите новую сумму на месяц, например: 150000'
        ),
        'goal_alert_category_achieved': (
            '🎉 <b>Цель достигнута!</b>\n\n'
            '{category}\n'
            'Цель: {amount}\n'
            'Получено: {received} ({percent}%)'
        ),
        'goal_alert_total_achieved': (
            '🎉 <b>Цель по доходу достигнута!</b>\n\n'
            'Цель: {amount}\n'
            'Получено: {received} ({percent}%)'
        ),
...
Спасибо за участие в тестировании! Ваши отзывы помогают улучшать бот.''',
        ...
        # Инструменты
        'tools_menu': '🛠️ Инструменты',
        'tools_active_header': 'Активны:',
...
Бот понимает разговорный язык и поможет с анализом ваших финансов.''',
        ...
        # Group chat explicit input — MVP
        'group_format_hint': 'Формат: <code>!кофе 200</code> — трата, <code>!зарплата +50000</code> — доход.',
        'group_privacy_deeplink': (
            'Чтобы я записывал ваши траты, откройте меня в личке и примите политику: '
            '<a href="https://t.me/{bot_username}?start=group">@{bot_username}</a>'
        ),
        'group_income_premium': (
            'Учёт доходов — премиум-функция. Оформите подписку в личке: '
            '<a href="https://t.me/{bot_username}?start=group">@{bot_username}</a>'
        ),
        'group_privacy_callback_alert': (
            'Чтобы пользоваться ботом, откройте его в личке и примите политику конфиденциальности.'
        ),
        'group_welcome': (
            '🤝 Привет! Я записываю траты и доходы.\n'
            '⚙️ Чтобы я получал записи в этой группе, назначьте меня администратором. '
            'Дополнительные права мне не нужны.\n'
            '• Быстрый ввод: поставьте <code>!</code> перед записью — <code>!кофе 200</code>\n'
            '• Или обратитесь ко мне: <code>@{bot_username} кофе 200</code>\n'
            '• Доход: добавьте <code>+</code> (или «плюс», «п») перед суммой — <code>!зарплата +50000</code>\n'
...
"Show expenses for July"''',
        ...
        # --- Spending limits ---
        'limit_button_set': '🎚️ Set limit',
        'limit_button_with_amount': '🎚️ Limit: {amount}/mo',
        'limit_category_header': '🎚️ Category limit\n{category}',
        'limit_screen_body': (
            'Limit: <b>{amount}</b> per month\n'
            'Spent: {spent} ({percent}%)\n'
            'Days left in month: {days_left}'
        ),
        'limit_edit_button': '✏️ Change limit',
        'limit_remove_button': '🗑 Remove limit',
        'limit_input_prompt': (
            '🎚️ Set limit\n{category}\n\n'
            'Enter the monthly limit amount, e.g.: 10000'
        ),
        'limit_input_prompt_change': (
            '🎚️ Change limit\n{category}\n\n'
            'Current limit: {amount}. Enter the new monthly amount, e.g.: 10000'
        ),
        'limit_set_success': '✅ Limit set: {amount}/mo',
        'limit_removed_success': '✅ Limit removed',
        'limit_invalid_amount': '❌ Enter a valid limit amount greater than zero',
        'limit_days_left_one': '{n} day',
        'limit_days_left_few': '{n} days',
        'limit_days_left_many': '{n} days',
        # --- Total spending limit ---
        'total_limit_button': '🎚️ Spending limit',
        'total_limit_header': '🎚️ Total spending limit',
        'total_limit_explainer': (
            '💡 <i>Progress is shown in the «Budget» menu — a bar under your '
            'monthly expenses total. You will get a notification at 80% and 100% '
            'of the limit. Per-category limits can be set in the «Categories» menu '
            '→ ✏️ Edit → pick a category.</i>'
        ),
        'total_limit_input_prompt': (
            '🎚️ Total spending limit\n\n'
            '💡 <i>Progress will be shown in the «Budget» menu — a bar under your '
            'monthly expenses total. You will get a notification at 80% and 100% '
            'of the limit. Per-category limits can be set in the «Categories» menu.</i>\n\n'
            'Enter the monthly limit amount, e.g.: 50000'
        ),
        'total_limit_input_prompt_change': (
            '🎚️ Total spending limit\n\n'
            'Current limit: {amount}. Enter the new monthly amount, e.g.: 50000'
        ),
        ...
        'limit_alert_total_80': (
            '🟡 <b>80% of spending limit reached</b>\n\n'
            'Spent: {spent} / {amount}\n'
            'Remaining: {remaining}\n'
            'Days left in month: {days_left}'
        ),
        'limit_alert_total_exceeded': (
            '🔴 <b>Total spending limit exceeded!</b>\n\n'
            'Limit: {amount}\n'
            'Spent: {spent} ({percent}%)\n'
            'Days left in month: {days_left}'
        ),
        # --- Income goals ---
        'goal_button_set': '🎯 Set goal',
        'goal_button_with_amount': '🎯 Goal: {amount}/mo',
        'goal_category_header': '🎯 Category goal\n{category}',
        'goal_screen_body': (
            'Goal: <b>{amount}</b> per month\n'
            'Received: {received} ({percent}%)\n'
            'Days left in month: {days_left}'
        ),
        'goal_edit_button': '✏️ Change goal',
        'goal_remove_button': '🗑 Remove goal',
        'goal_input_prompt': (
            '🎯 Set goal\n{category}\n\n'
            'Enter the monthly goal amount, e.g.: 100000'
        ),
        'goal_input_prompt_change': (
            '🎯 Change goal\n{category}\n\n'
            'Current goal: {amount}. Enter the new monthly amount, e.g.: 100000'
        ),
        'goal_removed_success': '✅ Goal removed',
        'goal_invalid_amount': '❌ Enter a valid goal amount greater than zero',
        'total_goal_button': '🎯 Income goal',
        'total_goal_header': '🎯 Total income goal',
        'total_goal_explainer': (
            '💡 <i>Progress is shown in the «Budget» menu — a bar under your '
            'monthly income total. You will get a notification when 100% of the '
            'goal is reached. Per-category goals can be set in the «Income '
            'Categories» menu → ✏️ Edit → pick a category.</i>'
        ),
        'total_goal_input_prompt': (
            '🎯 Total income goal\n\n'
            '💡 <i>Progress will be shown in the «Budget» menu — a bar under your '
            ...
            'goal is reached. Per-category goals can be set in the «Income '
            'Categories» menu.</i>\n\n'
            'Enter the monthly goal amount, e.g.: 150000'
        ),
        'total_goal_input_prompt_change': (
            '🎯 Total income goal\n\n'
            'Current goal: {amount}. Enter the new monthly amount, e.g.: 150000'
        ),
        'goal_alert_category_achieved': (
            '🎉 <b>Goal reached!</b>\n\n'
            '{category}\n'
...
The bot understands natural language and will help analyze your finances.''',
        ...
        'delete_button': '➖ Delete',
        # Group chat explicit input — MVP
        'group_format_hint': 'Format: <code>!coffee 200</code> — expense, <code>!salary +50000</code> — income.',
        'group_privacy_deeplink': (
            'To let me record your expenses, open me in a private chat and accept the policy: '
            '<a href="https://t.me/{bot_username}?start=group">@{bot_username}</a>'
        ),
        'group_income_premium': (
            'Income tracking is a premium feature. Subscribe in a private chat: '
            '<a href="https://t.me/{bot_username}?start=group">@{bot_username}</a>'
        ),
        'group_privacy_callback_alert': (
            'To use the bot, open it in a private chat and accept the privacy policy.'
        ),
        'group_welcome': (
            '🤝 Hi! I record expenses and income.\n'
            '⚙️ To let me receive entries in this group, make me an administrator. '
            'I do not need any additional permissions.\n'
            '• Quick entry: put <code>!</code> before it — <code>!coffee 200</code>\n'
            '• Or mention me: <code>@{bot_username} coffee 200</code>\n'
            '• Income: add <code>+</code> (or "plus", "p") before the amount — <code>!salary +50000</code>\n'
            'Entries go to the personal budget of whoever sent them. I don\'t read regular messages.'
        ),
    }
}

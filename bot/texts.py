...
Пример: "альфабанк 5% 2000 руб"''',
        ...
        'auto_convert_enabled': '✅ Автоконвертация включена',
        'auto_convert_disabled': '⬜ Автоконвертация выключена',
...
Example: "alphabank 5% 2000 rub"''',
        ...
        'auto_convert_enabled': '✅ Auto-conversion enabled',
        'auto_convert_disabled': '⬜ Auto-conversion disabled',

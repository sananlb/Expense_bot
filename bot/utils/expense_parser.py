...
# ВАЖНО: знак "+" считается маркером дохода ТОЛЬКО в начале сообщения перед числом.
# В середине текста "+" — просто часть текста (C++ 500, кофе + 200, долг +1200).
# Слова "плюс"/"plus" работают и в середине, т.к. это явное намерение пользователя.
INCOME_PATTERNS = [

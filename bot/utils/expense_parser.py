...
AMOUNT_PATTERNS = [
    ...
    r'(\d{1,3}(?:[\s,]\d{3})+(?:[.,]\d+)?)\s*(?:руб|рублей|р|₽)',  # 10 000 руб
    r'(\d{1,3}(?:[\s,]\d{3})+(?:[.,]\d+)?)\s*(?:usd|\$|долл|доллар)',  # 10 000 USD
    r'(\d{1,3}(?:[\s,]\d{3})+(?:[.,]\d+)?)\s*(?:eur|€|евро)',  # 10 000 EUR
    r'(\d{1,3}(?:[\s,]\d{3})+(?:[.,]\d+)?)\s*(?:cny|¥|юан|юаней)',  # 10 000 CNY
    r'(\d{1,3}(?:[\s,]\d{3})+(?:[.,]\d+)?)\s*(?:ars|песо|аргентинских?)',  # 10 000 ARS
    r'(\d{1,3}(?:[\s,]\d{3})+(?:[.,]\d+)?)\s*(?:cop|колумбийских?)',  # 10 000 COP
    r'(\d{1,3}(?:[\s,]\d{3})+(?:[.,]\d+)?)\s*(?:pen|солей?|перуанских?)',  # 10 000 PEN
    r'(\d{1,3}(?:[\s,]\d{3})+(?:[.,]\d+)?)\s*(?:clp|чилийских?)',  # 10 000 CLP
    r'(\d{1,3}(?:[\s,]\d{3})+(?:[.,]\d+)?)\s*(?:mxn|мексиканских?)',  # 10 000 MXN
    r'(\d{1,3}(?:[\s,]\d{3})+(?:[.,]\d+)?)\s*(?:brl|реалов?|бразильских?)',  # 10 000 BRL

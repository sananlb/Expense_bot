...
15. get_expenses_list(start_date='2025-08-01', end_date='2025-08-31') - ИСПОЛЬЗУЙ ЭТУ ФУНКЦИЮ для "Покажи ВСЕ траты в августе/за любой месяц/за период/последние 2 недели" (преобразуй месяц в конкретные даты)
...
2. Для запросов о тратах за месяц (например "покажи все траты в августе") используй get_expenses_list и преобразуй месяц в даты:
   - август 2025 = start_date='2025-08-01', end_date='2025-08-31'
   - прошлый месяц = вычисли даты предыдущего месяца
   - последние 2 недели = от (сегодня - 14 дней) до сегодня

...
def test_no_false_positives():
    ...
    test_cases = [
        ...
        ("тест", "Сосиска в тесте и чай", False),  # "тест" не в начале - не должно совпадать
...
def test_inflections():
    ...
    test_cases = [
        # (keyword, text, should_match, expected_type)
        # ВАЖНО: склонения работают для одиночного keyword с ПЕРВЫМ словом текста
        ...
        # Одиночное слово vs фраза (НОВОЕ ПОВЕДЕНИЕ - должно матчить первое слово!)
...
def test_real_world_scenarios():
    ...
    test_cases = [
        ...
        ("тест", "Сосиска в тесте и чай 390", False),  # НЕ должно совпадать (тест не в начале)

        # Сценарий 2: "Водица" как одиночный keyword ДОЛЖЕН матчить фразу через inflection
        # Старое ожидание было неправильным - одиночные keywords работают с первым словом!

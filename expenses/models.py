...
CATEGORY_KEYWORDS = {
    ...
    'Кафе и рестораны': [
        ...
        'cappuccino', 'latte', 'espresso', 'americano', 'tea'
    ],
    'АЗС': [
    ...
    'Аптеки': [
        ...
        # English keywords
        'drugstore', 'medicine', 'pills', 'vitamins', 'supplements', 'prescription',
        'medication', 'drugs', 'cvs', 'walgreens', 'rite aid'
    ],
    'Медицина': [
    ...
    'Подарки': [
        ...
        # English keywords
        'present', 'souvenir', 'flowers', 'bouquet', 'card', 'birthday', 'anniversary',
        'wedding', 'celebration', 'party', 'balloons'
    ],
    'Путешествия': [

...
Expense Bot и Nutrition Bot на разных серверах проверяют доступность друг друга каждые 11 минут. При падении одного — второй шлёт алерт в Telegram. Подробнее: [ENHANCED_MONITORING.md](ENHANCED_MONITORING.md)

### Автоматический бекап БД на Google Drive (добавлено 2026-02-19)
Ежедневный бекап БД в 23:58 МСК через cron → Google Drive (30 копий) + локально (3 копии). Подробнее: [BACKUP_GDRIVE_PLAN.md](BACKUP_GDRIVE_PLAN.md)

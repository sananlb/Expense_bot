# Автоматический ежедневный бекап БД на Google Drive

## Статус: АКТИВЕН (с 2026-02-19)

## Контекст
Ранее не было автоматического бекапа базы данных. Существующие скрипты (`scripts/backup_local.sh`, `scripts/backup_to_reserve.sh`) — ручные, с устаревшими IP и неправильным пользователем БД в некоторых из них. Нужен надёжный автоматический бекап на Google Drive с уведомлениями в Telegram.

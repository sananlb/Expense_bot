...
@pytest.mark.parametrize(
    ...
    [
        ("Аренда 48000", False, {"description": "Аренда", "amount": 48000.0, "is_income": False}),
        ("Недвижимость 1000000", False, {"description": "Недвижимость", "amount": 1000000.0, "is_income": False}),
        ("Интернет 1500.50", False, {"description": "Интернет", "amount": 1500.5, "is_income": False}),
        ("Интернет 1 500.50", False, {"description": "Интернет 1", "amount": 500.5, "is_income": False}),
        ("Кофе 150,5", False, {"description": "Кофе", "amount": 150.5, "is_income": False}),
        # Исключение для пробела перед группой "000": сумма склеивается.
        ...
        ("Зарплата п150 000", False, {"description": "Зарплата", "amount": 150000.0, "is_income": True}),
        ("Зарплата п 150 000", False, {"description": "Зарплата", "amount": 150000.0, "is_income": True}),
        ("Покупка 50 000 руб", False, {"description": "Покупка", "amount": 50000.0, "is_income": False}),
        # А вот не-"000" группа после пробела НЕ склеивается: "1 500" => 500, "1" в описание.
        ("Кофе 1 500", False, {"description": "Кофе 1", "amount": 500.0, "is_income": False}),
        ("48000", True, {"description": None, "amount": 48000.0, "is_income": False}),
        ("Зарплата плюс 150000", False, {"description": "Зарплата", "amount": 150000.0, "is_income": True}),
        ("Зарплата п150000", False, {"description": "Зарплата", "amount": 150000.0, "is_income": True}),
        ("Зарплата п 150000", False, {"description": "Зарплата", "amount": 150000.0, "is_income": True}),
        ("Salary p3000", False, {"description": "Salary", "amount": 3000.0, "is_income": True}),
        ("Salary p 3000", False, {"description": "Salary", "amount": 3000.0, "is_income": True}),
        ("Покупка 50000 руб", False, {"description": "Покупка", "amount": 50000.0, "is_income": False}),
        ...
        ("Подарок 5000", False, {"description": "Подарок", "amount": 5000.0, "is_income": False}),
        ("Pasta 20", False, {"description": "Pasta", "amount": 20.0, "is_income": False}),
        ("Доход д 5000", False, {"description": "Доход д", "amount": 5000.0, "is_income": False}),
        ("+ 5000", True, {"description": None, "amount": 5000.0, "is_income": True}),
        ("п 5000", True, {"description": None, "amount": 5000.0, "is_income": True}),
        ("p 5000", True, {"description": None, "amount": 5000.0, "is_income": True}),
